...
namespace WLWSimpleAnchorManager
{
    class AnchorBuilder : AnchorBuilderBase
    {
        ...
        public override string getPublishHtml()
        {
            ...
            newAnchor.Attributes.Add(new htmlAttribute("name", wlwAnchorFlag + ":" + this.AnchorSettings.AnchorName, '"'));
        ...
        {
            htmlElement newAnchor = new htmlElement("a", false);
            newAnchor.Attributes.Add(new htmlAttribute("name", AnchorBuilderBase.wlwAnchorFlag + ":" + this.AnchorSettings.AnchorName, '"'));
