...
namespace WLWSimpleAnchorManager
{
    public class WLWPostContentHelper
    {
        ...
        //public static string LinkTagRegexPattern = "<A\\s.*name=" + AnchorData.wlwLinkToAnchorFlag + ":.*?(>|\\s+>)";
        //public static string AnchorTagRegexPattern = "<A\\sname=" + AnchorData.wlwAnchorFlag + ":.*?(>|\\s+>)";
